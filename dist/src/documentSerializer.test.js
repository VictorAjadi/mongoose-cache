...
console.log('✓ Nested ObjectIds converted:', typeof serialized2.author._id === 'string' &&
...
console.log('✓ Nested types handled:', typeof serialized3.nested.id === 'string' &&
...
console.log('✓ Primitive types match:', deserialized.name === original.name &&
    deserialized.tags.length === original.tags.length);
console.log('✓ ObjectId strings recovered:', typeof deserialized._id === 'string' &&
    typeof deserialized.nested.id === 'string');
console.log('✓ ISO date strings recovered:', typeof deserialized.createdAt === 'string' &&
...
console.log('✓ estimateSize() is reasonable:', DocumentSerializer.estimateSize(testObj) > 0 &&
